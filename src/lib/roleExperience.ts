...
const EXPERIENCE_BY_ARCHETYPE: Record<RoleArchetype, Omit<RoleExperience, 'archetype'>> = {
  ...
  ministry_leader: {
    ...
    modulePriority: ['sunday-mode', 'sunday-services', 'attendance', 'volunteers', 'members', 'sermons', 'events', 'profile'],
    navGroupOrder: ['Operations', 'Identity', 'Engagement', 'Insights & Audit', 'Finance', 'Website', 'Platform'],
    quickOps: ['sunday-mode', 'sunday-services', 'attendance', 'volunteers', 'notifications'],
    showQuickOps: true,
