...
const EXPERIENCE_BY_ARCHETYPE: Record<RoleArchetype, Omit<RoleExperience, 'archetype'>> = {
  super_admin: {
    ...
    quickOps: ['dashboard', 'sunday-mode', 'attendance', 'volunteers', 'notifications', 'discipleship'],
    showQuickOps: true,
  ...
  church_admin: {
    ...
    modulePriority: ['dashboard', 'events', 'attendance', 'members', 'volunteers', 'communication', 'giving', 'settings', 'profile'],
    navGroupOrder: ['Operations', 'Identity', 'Engagement', 'Insights & Audit', 'Website', 'Platform'],
    quickOps: ['dashboard', 'sunday-mode', 'attendance', 'events', 'volunteers', 'notifications'],
    showQuickOps: true,
    dashboardShortcuts: ['events', 'attendance', 'members', 'volunteers'],
    sidebarAllowList: [
      'dashboard',
      'events',
      'sunday-mode',
  ...
  senior_pastor: {
    ...
    modulePriority: ['dashboard', 'members', 'discipleship', 'pathways', 'giving', 'analytics', 'events', 'outreach', 'profile'],
    ...
    showQuickOps: true,
    dashboardShortcuts: ['members', 'discipleship', 'giving', 'events'],
    preferPortal: false,
  },
  finance: {
  ...
  hr: {
    ...
    dashboardLens: 'operations',
    visibleLenses: ['operations'],
    modulePriority: ['hr', 'workforce', 'members', 'vendors', 'documents', 'dashboard', 'profile'],
    navGroupOrder: ['Identity', 'Finance', 'Insights & Audit', 'Operations', 'Engagement', 'Website', 'Platform'],
    quickOps: ['hr', 'workforce', 'members', 'notifications', 'dashboard'],
    showQuickOps: true,
    dashboardShortcuts: ['hr', 'workforce', 'members', 'vendors'],
    preferPortal: false,
  },
  ministry_leader: {
    title: 'Ministry operations',
    subtitle: 'Services, teams, attendance, and worship planning.',
    landingModule: 'sunday-mode',
    dashboardView: 'operations',
    dashboardLens: 'operations',
    visibleLenses: ['operations', 'pastoral'],
    modulePriority: ['sunday-mode', 'events', 'attendance', 'worship', 'volunteers', 'members', 'sermons', 'profile'],
    navGroupOrder: ['Operations', 'Identity', 'Engagement', 'Insights & Audit', 'Finance', 'Website', 'Platform'],
    quickOps: ['sunday-mode', 'attendance', 'events', 'worship', 'volunteers', 'notifications'],
    showQuickOps: true,
    dashboardShortcuts: ['sunday-mode', 'events', 'attendance', 'worship'],
    preferPortal: false,
  },
  youth_pastor: {
    ...
    dashboardLens: 'operations',
    visibleLenses: ['operations'],
    modulePriority: ['sunday-mode', 'events', 'attendance', 'worship', 'members', 'discipleship', 'sermons', 'profile'],
    navGroupOrder: ['Operations', 'Identity', 'Engagement'],
    quickOps: ['sunday-mode', 'events', 'attendance', 'worship', 'members', 'notifications'],
    showQuickOps: true,
    dashboardShortcuts: ['sunday-mode', 'events', 'attendance', 'worship'],
    sidebarAllowList: [
      'dashboard',
  ...
  volunteer_coordinator: {
    ...
    landingModule: 'volunteers',
    dashboardView: 'operations',
    dashboardLens: 'operations',
    visibleLenses: ['operations'],
    modulePriority: ['volunteers', 'events', 'attendance', 'members', 'sunday-mode', 'profile'],
    navGroupOrder: ['Operations', 'Identity'],
    quickOps: ['volunteers', 'sunday-mode', 'attendance', 'events', 'members', 'notifications'],
    showQuickOps: true,
    dashboardShortcuts: ['volunteers', 'events', 'attendance', 'members'],
    sidebarAllowList: [
      'dashboard',
      'volunteers',
      'events',
  ...
  staff_desk: {
    ...
    sidebarAllowList: ['dashboard', 'members', 'events', 'notifications', 'sunday-mode', 'attendance', 'families'],
    focusedHome: true,
    preferPortal: false,
  },
  communications: {
