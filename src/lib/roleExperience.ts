...
const EXPERIENCE_BY_ARCHETYPE: Record<RoleArchetype, Omit<RoleExperience, 'archetype'>> = {
  ...
  senior_pastor: {
    ...
    subtitle: 'People who need your care and prayer this week.',
    landingModule: 'dashboard',
    dashboardView: 'executive',
    dashboardLens: 'pastoral',
    visibleLenses: ['pastoral'],
  ...
  youth_pastor: {
    ...
    subtitle: 'Youth events, attendance, and team coordination for the next generation.',
    landingModule: 'events',
    dashboardView: 'operations',
    dashboardLens: 'operations',
    visibleLenses: ['operations'],
  ...
  volunteer_coordinator: {
    ...
    dashboardLens: 'operations',
    visibleLenses: ['operations'],
    modulePriority: ['volunteers', 'events', 'attendance', 'sunday-mode', 'small-groups', 'members', 'profile'],
    navGroupOrder: ['Operations', 'Identity'],
    quickOps: ['volunteers', 'events', 'sunday-mode', 'attendance', 'members', 'notifications'],
    showQuickOps: true,
    dashboardShortcuts: ['volunteers', 'events', 'attendance', 'sunday-mode'],
    sidebarAllowList: [
      'dashboard',
      'volunteers',
      'events',
  ...
  staff_desk: {
    ...
    showQuickOps: true,
    dashboardShortcuts: ['members', 'outreach', 'events', 'sunday-mode', 'notifications'],
